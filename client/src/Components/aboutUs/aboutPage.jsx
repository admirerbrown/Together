...
const AboutUsPage = () => {
  ...
  return (
    <div>
      <div className="flex flex-col items-center md:flex-row pt-20 md:pt-0 pb-28 gap-5 md:gap-8 md:px-0 md:justify-center px-11 lg:px-8 bg-[#f6f5f2]">
        <div className=" w-[280px] h-[160px] md:w-[340px] md:h-[200px] lg:w-[450px] lg:pt-16 lg:h-[320px] 2xl:w-[550px] overflow-hidden">
          <img
        ...
        <div className="flex flex-col gap-4 md:w-[38%] lg:w-[50%]">
          <h1 className="font-extrabold text-2xl md:text-[28px] lg:text-[33px] md:mt-16 lg:mt-4 font-Open-Sans">WHO WE ARE</h1>
          <h2 className="text-[15.5px] md:text-[17px] lg:text-[20px]">
            We are here not for income, but for outcome
          </h2>
          <p className="text-[13px] md:text-[14px] lg:text-[14.5px] text-zinc-500 leading-6">
