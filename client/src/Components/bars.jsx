...
const Summary = () => {
    return (
        <div className='flex gap-12 2xl:gap-[6rem] w-full flex-col md:flex-row items-center justify-center mt-10 lg:mt-0 pb-20 md:px-16 lg:px-10 2xl:px-0 xl:pb-[100px] 2xl:pb-16 '>
