  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="pl-12">
          <p className=" mb-2 md:pl-0 text-[22px] md:text-[22px] xl:text-[25px] font-bold text-[#333] text-start w-full md:px-0 hover:text-[#ff6900]">
            My Donations
          </p>
          ...
          <div>
            <form action="#">
              <label htmlFor="donationEmail" className="text-[#8a8a8a] text-[15px] font-bold">Donation Email:</label>
              <br></br>
              <input
                type="text"
                id="donationEmail"
    ...
    <>
      <div className="flex flex-col  lg:w-[400px] xl:w-[320px] 2xl:w-[340px] items-center mt-10">
        ...
        <div className=" justify-center items-center md:px-10 lg:px-0 xl:pl-2 2xl:pl-0 flex flex-col gap-2 mt-6">
          <p className="pl-11 md:pl-0 text-[22px] md:text-[22px] xl:text-[25px] font-bold text-[#333] text-start w-full md:px-0 hover:text-[#ff6900]">
            Our Goal
          </p>
