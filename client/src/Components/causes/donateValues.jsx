...
const DonateForm = ({ item }) => {
  ...
  return (
    <div className="2xl:flex 2xl:flex-col 2xl:items-start font-Open-Sans mt-12 lg:mt-8 md:w-full 2xl:w-full ">
      <div className="2xl:flex 2xl:flex-col ">
        <h1 className="ml-10 text-[40px] leading-[2.7rem] pr-5 lg:ml-0 font-bold text-[#84c54e]">
          {item.title}
        </h1>
        <p className="px-10 text-[12.5px] pt-8 lg:px-0 lg:pr-8 lg:text-[14px] xl:text-[15.5px] xl:w-[100%] 2xl:w-[72%]  leading-[1.5rem]">
          {item.description}
        </p>

        <div className="flex flex-col px-10 mb-10 lg:px-0">
          <p className="text-[#84c54e] xl:text-[24px] font-bold mb-3 mt-5">
            Donation Form
          </p>
