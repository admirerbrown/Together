            ...
            <div className="px-10 md:px-14 font-Open-Sans text-zinc-400 md:flex md:w-full md:justify-center md:gap-8">
                <div className="flex flex-col gap-4 md:gap-6 md:w-[40%]">
                    <div >
                        ...
                        <p className="text-xs md:text-[14px] mb-2">
                        ...
                        <p className="text-xs text-[#84c54e] md:text-[14px] mb-2">
                    ...
                    <div >
                        ...
                        <p className="text-[13px] md:text-[14.5px] md:leading-6 text-zinc-400">
                ...
                <div className="md:w-[50%]"><ContactForm></ContactForm></div>
            </div>
        </div>
    );
};
