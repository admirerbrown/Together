        ...
        <div className="">
            ...
            <div className="px-10 md:px-14 lg:px-0 xl:px-20 font-Open-Sans text-zinc-400 md:flex md:w-full md:justify-center md:gap-8">
                <div className="flex flex-col gap-4 md:gap-6 md:w-[40%] xl:w-[37%] 2xl:w-[27%]">
                    <div >
                        <h2 className="font-bold text-lg mb-4 xl:text-2xl  text-[#424242]">Contact Info</h2>
                        <p className="text-xs md:text-[14px] mb-2 xl:text-[16px]">
                            <span className="font-bold text-sm xl:text-[16px] text-[#424242]">Address:</span> No.1 Abbey Road, London, W1 ECH, UK
                        </p>
                        <p className="text-xs md:text-[14px] mb-2 xl:text-[16px]">
                            <span className="font-bold text-sm xl:text-[16px] text-[#424242]">We Are Open:</span> Open House on the 24th, – 12 mid day to
                            5 pm.
                        </p>
                        <p className="text-xs text-[#84c54e] md:text-[14px] mb-2 xl:text-[16px]">
                            <span className="font-bold text-sm xl:text-[16px] text-[#424242]">Call:</span> +233 (0) 800 123 4567
                        </p>
                        <p className="text-xs text-[#84c54e] md:text-[14px] mb-2 xl:text-[16px]">
                            <span className="font-bold text-sm xl:text-[16px] text-[#424242]">Email:</span> hr@together.com
                        </p>
                    </div>
                    <div >
                        <h2 className="font-bold font-Open-Sans text-lg xl:text-2xl mb-4 text-[#424242] ">Information</h2>
                    ...
                    <div className="">
                        <h2 className="font-bold font-Open-Sans text-lg xl:text-2xl mb-4 text-[#424242]">Stay Social</h2>
                ...
                <div className="md:w-[50%] 2xl:w-[40%]"><ContactForm></ContactForm></div>
            </div>
        </div>
    );
};
