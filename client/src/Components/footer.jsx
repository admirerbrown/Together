...
const Footer = () => {
  return (
    <div>
      <div className="bg-[#333] flex py-24 items-center justify-center gap-14">
        <div className="flex flex-col gap-6 w-[28%] text-[15px] mr-5">
          <img src="" alt="logo" />
          <p className="text-[#8a8a8a] leading-[1.5rem]">
        ...
        <div className=" flex flex-col gap-14 font-Open-Sans font-semibold text-lg">
          <div>
          ...
          <div>
            ...
            <div className="join ">
              <input
                type="text"
                placeholder="Email"
                className="input input-bordered rounded-[0.2rem] bg-[#464646] border focus:border-[#999] w-[420px]"
              />
              <button className="btn btn-md ml-3 rounded-[0.2rem] border-none text-[18px] bg-[#84c54e] hover:bg-[#ff6900] text-white">Subscribe</button>
            </div>
          </div>
          <div>
            <h1 className="text-[#e0e0e0] mb-5 font-bold">CONNECT WITH US</h1>
            <ul className="socials flex text-[#acb4b6] ">
              <li className="flex justify-center  h-10 w-10  items-center   hover:text-[#84c54e]" ><FaXTwitter className="text-3xl "></FaXTwitter></li>
              <li className="flex justify-center  h-10 w-10  items-center   hover:text-[#84c54e]"><FaFacebookF className="text-2xl "></FaFacebookF></li>
              <li className="flex justify-center  h-10 w-10  items-center   hover:text-[#84c54e]"><TfiYoutube className="text-2xl "></TfiYoutube></li>
              <li className="flex justify-center  h-10 w-10  items-center  hover:bg-transparent hover:text-[#84c54e]"><FaPinterestP className="text-xl "></FaPinterestP></li>
            </ul>
          </div>
        </div>
      </div>
      <div className="h-[8rem] flex items-center justify-center bg-[#0f0f0f]">
        <p className="text-[#8a8a8a] text-sm">Built by <span className="text-[#84c54e]">Submarine-Tech</span> © 2023 All Rights Reserved.</p>
      </div>
    </div>
